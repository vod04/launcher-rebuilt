...
function LoadAssets()
    Replace("launcher/media/textures/arena lite hd/")
    Replace("launcher/media/textures/arena lite hd/"..Launcher.Game.HomeNameAbbreviation().."/")  
end
...
if Launcher.Config.Bool("arenalitehd",true) then
